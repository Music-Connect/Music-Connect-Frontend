...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-purple-950 text-white font-sans">
      {/* Header */}
      <header className="flex justify-between items-center py-6 px-8 md:px-16">
        <div className="text-4xl font-black text-yellow-300">
          Music
          <span className="bg-gradient-to-r from-yellow-300 to-pink-500 bg-clip-text text-transparent">
            Connect
          </span>
        </div>
      ...
      <main>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center py-16 px-12 md:px-20">
          ...
          <div className="md:w-1/2 mt-12 md:mt-0">
            <div className="w-full h-auto max-w-lg mx-auto bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-3xl aspect-square flex items-center justify-center text-6xl">
              🎵
            </div>
          </div>
        </div>
